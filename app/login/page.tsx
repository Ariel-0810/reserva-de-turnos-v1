...
import { Calendar, Mail, Lock, ArrowLeft, KeyRound } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import toast from 'react-hot-toast';

type ViewMode = 'login' | 'forgot-email' | 'forgot-code' | 'forgot-newpassword';
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {viewMode === 'login' && (
            <>
              ...
              {/* Google Sign In - Hidden for now, can be enabled with NEXT_PUBLIC_ENABLE_GOOGLE_SSO=true */}
          ...
          {viewMode === 'forgot-email' && (
            <>
              ...
              <form onSubmit={handleSendRecoveryCode} className="space-y-5">
                ...
                <Button type="submit" className="w-full" size="lg" loading={sendingCode}>
            ...
            <>
              ...
              <div className="bg-violet-50 border border-violet-200 rounded-lg p-3 mb-6">
                <p className="text-sm text-violet-700">
                  Enviamos un código de 6 dígitos a <strong>{forgotEmail}</strong>
                </p>
              </div>
              ...
              <form onSubmit={handleResetPassword} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-center text-2xl font-mono tracking-[0.5em] py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
                    required
                  />
                </div>
                ...
                <Button type="submit" className="w-full" size="lg" loading={verifyingCode}>
                  Cambiar contraseña
                </Button>
              </form>
